...
# Hello, World I'm a passionate IT back-end developer. 👋

 
제가 개발하는 모습을 나타내는 세 가지 키워드는 팀빌딩, 성실함, 신중함입니다.
...
- **[2025 Kakao X 9oorm 시즌톤]** **우수상 & 특별상(LottieFiles)** 🏆  
  - 프로젝트명: 단짝이(GluCareLLM) – 1형 당뇨 아동을 위한 게이미피케이션 기반 자기관리 플랫폼
  - 예선전: 총 참가 400팀 중 20팀 본선 진출 (2025.09.06)
  - 본선전: 우수상 & 특별상(LottieFiles) 수상 (2025.09.20)
  - 역할: 백엔드  
  - 수상일: 2025.09.20

- **[2025 컴퓨터과학전공 캡스톤디자인]** **최우수상** 🏆  
  - 프로젝트명: SAMI(사미) - 상명대학교 AI 챗봇, 정량적 성능 평가 결과 바탕 연구 보고서
  - 결과물 1: SAMI(사미) - 상명대학교 AI 챗봇
  - 결과물 2: 파이썬 라이브러라 활용 SAMI(사미) 정량적 성능 평가와 이를 바탕으로 한 연구 보고서
  - 역할: 팀장 & 백엔드  
  - 수상일: 2025.11.26
...
## 📕 My Blog Posting
- [CQRS 📝 / 🔍](https://blog.naver.com/jungjune0/224098186630)
...
## SAMI(사미) - 상명대학교 AI 챗봇, 정량적 성능 평가 결과 바탕 연구 보고서
